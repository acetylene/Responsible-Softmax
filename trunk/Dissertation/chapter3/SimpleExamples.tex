...
\begin{eg}\label{eg:GMMExample}
		...
		\begin{figure}
			\centering
			\subcaptionbox{Here \( N=50 \). Ratios of the samples of the clusters are in the title. \label{fig:gmmExampleK2sub1}}[.4\linewidth]{
				\input{chapter3/K_2_N_50_1paramGMM}
			}
			%	\qquad
			\subcaptionbox{Here \( N=500 \). Ratios of the samples of the clusters are in the title. \label{fig:gmmExampleK2sub2}}[.4\linewidth]{
