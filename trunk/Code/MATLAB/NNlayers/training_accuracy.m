...
accFile = strcat(dir,...
    'acc_imba_',num2str(length(idx)),'_ovrlp_',...
    num2str(K),'_',num2str(scurr.Seed),'.xlsx');
confusionFile = strcat(dir,...
    'confusion_imba_',num2str(length(idx)),'_ovrlp_',...
    num2str(K),'_',num2str(scurr.Seed),'.xlsx');
pctFile = strcat(dir,...
    'tpr_fpr_imba_',num2str(length(idx)),'_ovrlp_',...
    num2str(K),'_',num2str(scurr.Seed),'.xlsx');
